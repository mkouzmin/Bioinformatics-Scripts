...
in_data_dir <- "/n/groups/flyrnai/mikhail/Yki_Tumor/run_count_all/"
fig_dir <- "/n/groups/flyrnai/mikhail/Yki_Tumor/batch_correction_figs/"
out_data_dir <- "/n/groups/flyrnai/mikhail/Yki_Tumor/batch_correction_data/"
