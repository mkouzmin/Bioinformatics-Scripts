...
in_data_dir <- "File location here"
...
#Run Harmony to integreate multiple data sets
...
#remove clusters we are not interested in - change this line as necessary on a case by case basis according to marker genes.
